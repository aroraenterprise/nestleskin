...
public class DashboardActivity extends AppCompatActivity
    ...
    private void initialize() {
        ...
        changeView(R.id.nav_facial_analysis); // set it to dashboard by default
    }
    ...
    private void changeView(int fragId){
        ...
        if (frag == null) { // no existing fragment
            if (fragId == R.id.nav_dashboard) {
                ...
                frag = FaceAnalysisFragment.newInstance();
            } else if (fragId == R.id.nav_tracker) {
                frag = TrackerFragment.newInstance();
            } else if (fragId == R.id.nav_diet) {
                frag = DietFragment.newInstance();
    ...
    protected void onDestroy() {
        SajHealthService.getInstance().destroy();
        super.onDestroy();
    }
}
